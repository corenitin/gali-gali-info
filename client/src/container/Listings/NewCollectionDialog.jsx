...
function NewCollectionDialog({ setDialogOpen }) {
  ...
  return (
    <div className="h-[calc(100vh-3.8rem)] w-[calc(100vw-12.65rem)] absolute bg-dark/30 flex justify-center items-center">
      <div className="relative w-96 h-52 bg-white rounded-3xl px-12 py-8 flex flex-col justify-evenly items-center">
        <button 
